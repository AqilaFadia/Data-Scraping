...
- [Spotify Playlist Scraper using API](https://github.com/AqilaFadia/Data-Scraping/blob/main/spotify-request-api.ipynb): This project demonstrates how to use the Spotify Web API to search for playlists based on a keyword (e.g. hip hop USA), extract metadata such as playlist name, URL, description, and follower count, and store it into a CSV file for further use or analysis.
